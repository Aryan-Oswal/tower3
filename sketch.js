...
function setup(){
    ...
    box5 = new BaseClass(400,100,50,50,0);
    box6 = new BaseClass(400,100,50,50,0);
    box7 = new BaseClass(450,100,50,50,0);
    box8 = new BaseClass(450,100,50,50,0);
    box9 = new BaseClass(500,100,50,50,0);
    box10 = new BaseClass(500, 100, 50, 50, 0);
    box21 = new BaseClass(550, 100, 50, 50, 0);
    box4 = new BaseClass(550,100,50,50,0);

    box23 = new BaseClass(200, 100, 50, 50, 0);
    ...
    box29= new BaseClass(50,450,50,50,0);
    box30= new BaseClass(700,500,50,50,0);
    box31 = new BaseClass(500, 550, 50, 50, 0);
    box32 = new BaseClass(550, 600, 50, 50, 0);

    

    ground2 = new Ground(500 , 350 , 300,10)
    ...
    box17 = new BaseClass(500,150,50,50,0);
    box18 = new BaseClass(400,150,50,50,0);
    box19 = new BaseClass(450,150,50,50,0);
    box20 = new BaseClass(450,150,50,50,0);
    box22 = new BaseClass(550,150,50,50,0);
    box33 = new BaseClass(500,150,50,50,0);



    ball = new Paper(700,300,40)

    slingshot = new Slingshot (ball.body , {x:700,y:200})
